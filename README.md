...
\color{redLibft(Library fortey two) is the <i style="color: #E9756F">first</i> project in the common core circle, in this project we were assigned the task of recreating/recoding most of Clib functions such as strlen, strcpy, atoi...<br><br>
